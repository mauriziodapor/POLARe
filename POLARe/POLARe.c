...
char in1[20],in2[20],in3[20],in4[20],in5[20],in6[20],in7[20];
...
//Gnuplot figures
    ...
    fprintf(gnuplotAD, "set ylabel '4 pi r^2 rho (10^{8}cm^{-1})' \n");
    ...
    fprintf(gnuplotAD, "set yrange [0:125] \n");
    fprintf(gnuplotAD, "set title 'Z=%ld' \n",(long int)Z);
    fprintf(gnuplotAD, "unset key \n");
    fprintf(gnuplotAD, "set xlabel 'r (bohr)' \n");
     fprintf(gnuplotAD, "set ylabel '4 pi r^2 rho (bohr^{-1})' \n");
    fprintf(gnuplotAD, "plot 'RESULTS/AD-Z=%ld.txt' w l \n",(long int)Z);
    fflush(gnuplotAD);
    fclose(gnuplotAD);
    system("gnuplot 'FIGURES/commandsAD.txt'");
