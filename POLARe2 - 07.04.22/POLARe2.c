/* POLARe2.c:
 ...
 Screening function: Cox and Bonham (Z<=54), Salvat et al.
 Exchange potential energy (only for electron projectiles): Mittleman and Watson/Furness and McCarty
 Polarization potential energy: Buckingham
 Correlation potential energy: Perdew and Zunger (electrons), Jain (positrons)
